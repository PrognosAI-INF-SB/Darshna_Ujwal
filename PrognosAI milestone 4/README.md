...
3. Run the Dashboard (Final Output)
The final deliverable, prognosai_dashboard.py, contains the full Streamlit application code. This file loads the model and assets generated in the notebooks to display the results and provide the live prediction tool.
Run the dashboard from the project root directory:
**streamlit run prognosai_dashboard.py**